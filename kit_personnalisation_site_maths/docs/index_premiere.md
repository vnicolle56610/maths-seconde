...
<section class="maths-brand">
  ...
  <div>
    ...
    <p>Un espace de travail pour construire les méthodes, consolider les automatismes et préparer progressivement les exigences du cycle terminal.</p>
  </div>
</section>

<section class="maths-hero">
  <div>
    <h2>Comprendre,<br>s'entraîner,<br>progresser.</h2>
    <p>Bienvenue sur le site de mathématiques du lycée Franklin. Vous y retrouverez les cours, les TD, les automatismes, les corrigés publiés et les ressources utiles pour travailler avec régularité.</p>
  ...
  <div class="maths-illustration" aria-hidden="true"></div>
</section>
...
<section class="maths-cards">
  ...
  <a class="maths-card maths-card--green" href="#acces-rapide">
    <span class="maths-card-icon">📝</span>
    <h3>TD</h3>
